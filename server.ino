...
String renderInputWithRange(int value, String name, int min = 0, int max = 255, bool isHsv = false, String type = "text") {
...
void handleSettingsGet() {
  ...
  html += "Night start hour (0-23): " + renderInputWithRange(NIGHT_START_HOUR, "NIGHT_START_HOUR", 0, 23) + "<br>";
  html += "Night end hour (0-23): " + renderInputWithRange(NIGHT_END_HOUR, "NIGHT_END_HOUR", 0, 23) + "<br>";

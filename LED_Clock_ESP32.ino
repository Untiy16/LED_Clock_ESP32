...
byte LDR_MIN_DAY_BRIGHTNESS = 5;
byte LDR_MAX_DAY_BRIGHTNESS = 70;
byte LDR_MIN_NIGHT_BRIGHTNESS = 1;
byte LDR_MAX_NIGHT_BRIGHTNESS = 30;
...
VarEntry vars[] = {
  ...
  {"LDR_MAX_DAY_BRIGHTNESS", "LDR_MAX_D_BRT", &LDR_MAX_DAY_BRIGHTNESS},
  {"LDR_MIN_NIGHT_BRIGHTNESS", "LDR_MIN_N_BRT", &LDR_MIN_NIGHT_BRIGHTNESS},
  {"LDR_MAX_NIGHT_BRIGHTNESS", "LDR_MAX_N_BRT", &LDR_MAX_NIGHT_BRIGHTNESS},
